...
jv_pg_m3_lang()
{
  case "$1" in
    ...
    light_on_success) zone_name=""; jv_pg_m3_zone_id_to_zone_name $2 $zone_name; echo "Lumières $zone_name allumées";;
    light_on_failed) zone_name=""; jv_pg_m3_zone_id_to_zone_name $2 $zone_name; echo "Echec de l'allumage des lumières $zone_name";;
